...
{
    /*
     hp,Maxhp,attackspeed,CriticalHit,Damage,Defence,Evasion,Gold,Jump,Shield
    ...
    public struct Status
    {
        ...
        public float p_evasion; // 이동속도

        public float p_jump; // 점프력
        
        public float p_gold; // 골드획득(골드획득량)
        public Status(int hp, float defence, float damage, float attackspeed, float criticalhit, float evasion, float jump, float gold)
        {
            p_hp = p_Maxhp = hp;
            p_defence = defence;
            p_damage = damage;
